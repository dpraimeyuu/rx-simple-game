import Rx from 'rx';
import { drawStars, drawSpaceShip, drawEnemies, drawSpaceshipShots, drawScore } from './drawing-helpers';
...
const { scoreSubject, score$ } = getScore$();
